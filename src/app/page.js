    ...
    if (view === 'SWAP_STATION' && swapTarget && typeof window !== 'undefined') {
      ...
      const initJupiter = () => {
        if (window.Jupiter) {
          ...
          try {
            if (jupiterInitialized) window.Jupiter.close();
            window.Jupiter.init({
